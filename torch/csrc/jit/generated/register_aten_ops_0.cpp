...
RegisterOperators reg({
  ...
  Operator(
      "aten::_copy_(Tensor(a!) self, Tensor src) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_copy_");
          auto self = (std::move(peek(stack, 0, 2))).toTensor();
          auto result_ = at::_copy_(
              self,
              (std::move(peek(stack, 1, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_sparse_coo_tensor_unsafe(Tensor indices, Tensor values, int[] size, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::_sparse_coo_tensor_with_dims_and_tensors(int sparse_dim, int dense_dim, int[] size, Tensor indices, Tensor values, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_sparse_coo_tensor_with_dims_and_tensors");
      
          const auto options = TensorOptions()
                  .dtype((std::move(peek(stack, 5, 8))).to<at::ScalarType>())
                  .layout((std::move(peek(stack, 6, 8))).to<at::Layout>())
                  .device((std::move(peek(stack, 7, 8))).to<at::Device>());
  ...
  Operator(
      "aten::_thnn_adaptive_avg_pool2d_forward(Tensor self, int[2] output_size, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_adaptive_avg_pool2d_forward_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_adaptive_avg_pool2d_forward_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
  ...
  Operator(
      "aten::_thnn_adaptive_avg_pool2d(Tensor self, int[2] output_size, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_adaptive_avg_pool2d_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_adaptive_avg_pool2d_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::_thnn_adaptive_avg_pool3d(Tensor self, int[3] output_size) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_adaptive_avg_pool3d");
      
          auto result_ = at::_thnn_adaptive_avg_pool3d(
              (std::move(peek(stack, 0, 2))).toTensor(),
  ...
  Operator(
      "aten::_thnn_avg_pool2d(Tensor self, int[2] kernel_size, int[2] stride=[], int[2] padding=0, bool ceil_mode=False, bool count_include_pad=True) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_avg_pool2d");
      
          auto result_ = at::_thnn_avg_pool2d(
              (std::move(peek(stack, 0, 6))).toTensor(),
  ...
  Operator(
      "aten::_thnn_binary_cross_entropy(Tensor self, Tensor target, Tensor? weight=None, int reduction=Mean, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_binary_cross_entropy_out");
          auto output = (std::move(peek(stack, 4, 5))).toTensor();
          auto result_ = at::_thnn_binary_cross_entropy_out(
              output,
              (std::move(peek(stack, 0, 5))).toTensor(),
              (std::move(peek(stack, 1, 5))).toTensor(),
              (std::move(peek(stack, 2, 5))).toTensor(),
  ...
  Operator(
      "aten::_thnn_conv2d(Tensor self, Tensor weight, int[2] kernel_size, Tensor? bias=None, int[2] stride=1, int[2] padding=0) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv2d");
      
          auto result_ = at::_thnn_conv2d(
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toTensor(),
              (std::move(peek(stack, 2, 6))).toIntList()->elements(),
  ...
  Operator(
      "aten::_thnn_conv_depthwise2d(Tensor self, Tensor weight, int[2] kernel_size, Tensor? bias=None, int[2] stride=1, int[2] padding=0, int[2] dilation=1) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv_depthwise2d");
      
          auto result_ = at::_thnn_conv_depthwise2d(
              (std::move(peek(stack, 0, 7))).toTensor(),
              (std::move(peek(stack, 1, 7))).toTensor(),
              (std::move(peek(stack, 2, 7))).toIntList()->elements(),
  ...
  Operator(
      "aten::_thnn_conv_dilated2d(Tensor self, Tensor weight, int[2] kernel_size, Tensor? bias=None, int[2] stride=1, int[2] padding=0, int[2] dilation=1) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv_dilated2d");
      
          auto result_ = at::_thnn_conv_dilated2d(
              (std::move(peek(stack, 0, 7))).toTensor(),
              (std::move(peek(stack, 1, 7))).toTensor(),
              (std::move(peek(stack, 2, 7))).toIntList()->elements(),
              (std::move(peek(stack, 3, 7))).toTensor(),
  ...
  Operator(
      "aten::_thnn_conv_transpose2d(Tensor self, Tensor weight, int[2] kernel_size, Tensor? bias=None, int[2] stride=1, int[2] padding=0, int[2] output_padding=0, int[2] dilation=1) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv_transpose2d");
      
          auto result_ = at::_thnn_conv_transpose2d(
              (std::move(peek(stack, 0, 8))).toTensor(),
              (std::move(peek(stack, 1, 8))).toTensor(),
              (std::move(peek(stack, 2, 8))).toIntList()->elements(),
              (std::move(peek(stack, 3, 8))).toTensor(),
  ...
  Operator(
      "aten::_thnn_elu(Tensor self, Scalar alpha=1, Scalar scale=1, Scalar input_scale=1, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_elu_out");
          auto output = (std::move(peek(stack, 4, 5))).toTensor();
          auto result_ = at::_thnn_elu_out(
              output,
              (std::move(peek(stack, 0, 5))).toTensor(),
              (std::move(peek(stack, 1, 5))).toScalar(),
              (std::move(peek(stack, 2, 5))).toScalar(),
  ...
  Operator(
      "aten::_thnn_hardtanh(Tensor self, Scalar min_val=-1, Scalar max_val=1, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_hardtanh_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_thnn_hardtanh_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toScalar(),
              (std::move(peek(stack, 2, 4))).toScalar()
  ...
  Operator(
      "aten::_thnn_l1_loss(Tensor self, Tensor target, int reduction=Mean, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_l1_loss_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_thnn_l1_loss_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toTensor(),
              (std::move(peek(stack, 2, 4))).toInt()
  ...
  Operator(
      "aten::_thnn_max_pool2d_with_indices(Tensor self, int[2] kernel_size, int[2] stride=[], int[2] padding=0, int[2] dilation=1, bool ceil_mode=False) -> (Tensor, Tensor)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_max_pool2d_with_indices");
      
          auto result_ = at::_thnn_max_pool2d_with_indices(
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toIntList()->elements(),
              (std::move(peek(stack, 2, 6))).toIntList()->elements(),
              (std::move(peek(stack, 3, 6))).toIntList()->elements(),
  ...
  Operator(
      "aten::_thnn_max_unpool3d(Tensor self, Tensor indices, int[3] output_size, int[3] stride, int[3] padding, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_max_unpool3d_out");
          auto output = (std::move(peek(stack, 5, 6))).toTensor();
          auto result_ = at::_thnn_max_unpool3d_out(
              output,
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toTensor(),
              (std::move(peek(stack, 2, 6))).toIntList()->elements(),
  ...
  Operator(
      "aten::_thnn_mse_loss(Tensor self, Tensor target, int reduction=Mean, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_mse_loss_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_thnn_mse_loss_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toTensor(),
              (std::move(peek(stack, 2, 4))).toInt()
  ...
  Operator(
      "aten::_thnn_multi_margin_loss(Tensor self, Tensor target, Scalar p=1, Scalar margin=1, Tensor? weight=None, int reduction=Mean, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_multi_margin_loss_out");
          auto output = (std::move(peek(stack, 6, 7))).toTensor();
          auto result_ = at::_thnn_multi_margin_loss_out(
              output,
              (std::move(peek(stack, 0, 7))).toTensor(),
              (std::move(peek(stack, 1, 7))).toTensor(),
              (std::move(peek(stack, 2, 7))).toScalar(),
  ...
  Operator(
      "aten::_thnn_nll_loss(Tensor self, Tensor target, Tensor? weight=None, int reduction=Mean, int ignore_index=-100) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_nll_loss");
      
          auto result_ = at::_thnn_nll_loss(
              (std::move(peek(stack, 0, 5))).toTensor(),
              (std::move(peek(stack, 1, 5))).toTensor(),
              (std::move(peek(stack, 2, 5))).toTensor(),
              (std::move(peek(stack, 3, 5))).toInt(),
  ...
  Operator(
      "aten::_thnn_nll_loss2d(Tensor self, Tensor target, Tensor? weight=None, int reduction=Mean, int ignore_index=-100) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_nll_loss2d");
      
          auto result_ = at::_thnn_nll_loss2d(
              (std::move(peek(stack, 0, 5))).toTensor(),
              (std::move(peek(stack, 1, 5))).toTensor(),
              (std::move(peek(stack, 2, 5))).toTensor(),
              (std::move(peek(stack, 3, 5))).toInt(),
  ...
  Operator(
      "aten::_thnn_reflection_pad1d(Tensor self, int[2] padding) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_reflection_pad1d");
      
          auto result_ = at::_thnn_reflection_pad1d(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_replication_pad1d(Tensor self, int[2] padding) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_replication_pad1d");
      
          auto result_ = at::_thnn_replication_pad1d(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_replication_pad3d(Tensor self, int[6] padding, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_replication_pad3d_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_replication_pad3d_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::_thnn_rrelu_with_noise(Tensor self, Tensor noise, Scalar lower=0.125, Scalar upper=0.333333333333, bool training=False, Generator generator=None, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_rrelu_with_noise_out");
          auto output = (std::move(peek(stack, 6, 7))).toTensor();
          auto result_ = at::_thnn_rrelu_with_noise_out(
              output,
              (std::move(peek(stack, 0, 7))).toTensor(),
              (std::move(peek(stack, 1, 7))).toTensor(),
              (std::move(peek(stack, 2, 7))).toScalar(),
  ...
  Operator(
      "aten::_thnn_soft_margin_loss(Tensor self, Tensor target, int reduction=Mean, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_soft_margin_loss_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_thnn_soft_margin_loss_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toTensor(),
              (std::move(peek(stack, 2, 4))).toInt()
  ...
  Operator(
      "aten::_thnn_softplus(Tensor self, Scalar beta=1, Scalar threshold=20, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_softplus_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_thnn_softplus_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toScalar(),
              (std::move(peek(stack, 2, 4))).toScalar()
  ...
  Operator(
      "aten::_thnn_upsample_nearest1d(Tensor self, int[1] output_size) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_upsample_nearest1d");
      
          auto result_ = at::_thnn_upsample_nearest1d(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_upsample_nearest3d(Tensor self, int[3] output_size, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_upsample_nearest3d_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_upsample_nearest3d_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::_thnn_upsample_trilinear3d(Tensor self, int[3] output_size, bool align_corners, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_upsample_trilinear3d_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_thnn_upsample_trilinear3d_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toIntList()->elements(),
              (std::move(peek(stack, 2, 4))).toBool()
  ...
  Operator(
      "aten::full(int[] size, Scalar fill_value, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::full_like(Tensor self, Scalar fill_value, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("full_like");
  ...
  Operator(
      "aten::index_put_(Tensor(a!) self, Tensor[] indices, Tensor values) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::mean(Tensor self, int dim, bool keepdim=False) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("mean");
  ...
  Operator(
      "aten::mean(Tensor self, int dim, *, ScalarType dtype) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("mean");
  ...
  Operator(
      "aten::randn(int[] size, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::randn_like(Tensor self, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("randn_like");
  ...
  Operator(
      "aten::rrelu_with_noise(Tensor self, Tensor noise, Scalar lower=0.125, Scalar upper=0.333333333333, bool training=False, Generator generator=None, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
