...
RegisterOperators reg({
  ...
  Operator(
      "aten::_th_linspace(Scalar start, Scalar end, int steps, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_th_linspace_out");
          auto result = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_th_linspace_out(
              result,
              (std::move(peek(stack, 0, 4))).toScalar(),
              (std::move(peek(stack, 1, 4))).toScalar(),
              (std::move(peek(stack, 2, 4))).toInt()
  ...
  Operator(
      "aten::_thnn_adaptive_avg_pool2d_backward(Tensor grad_output, Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_adaptive_avg_pool2d_backward");
      
          auto result_ = at::_thnn_adaptive_avg_pool2d_backward(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_adaptive_avg_pool3d(Tensor self, int[3] output_size, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_adaptive_avg_pool3d_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_adaptive_avg_pool3d_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::_thnn_adaptive_max_pool2d(Tensor self, int[2] output_size) -> (Tensor, Tensor)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_adaptive_max_pool2d");
      
          auto result_ = at::_thnn_adaptive_max_pool2d(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_avg_pool2d(Tensor self, int[2] kernel_size, int[2] stride=[], int[2] padding=0, bool ceil_mode=False, bool count_include_pad=True, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_avg_pool2d_out");
          auto output = (std::move(peek(stack, 6, 7))).toTensor();
          auto result_ = at::_thnn_avg_pool2d_out(
              output,
              (std::move(peek(stack, 0, 7))).toTensor(),
              (std::move(peek(stack, 1, 7))).toIntList()->elements(),
              (std::move(peek(stack, 2, 7))).toIntList()->elements(),
  ...
  Operator(
      "aten::_thnn_avg_pool3d(Tensor self, int[3] kernel_size, int[3] stride=[], int[3] padding=0, bool ceil_mode=False, bool count_include_pad=True) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_avg_pool3d");
      
          auto result_ = at::_thnn_avg_pool3d(
              (std::move(peek(stack, 0, 6))).toTensor(),
  ...
  Operator(
      "aten::_thnn_conv2d(Tensor self, Tensor weight, int[2] kernel_size, Tensor? bias=None, int[2] stride=1, int[2] padding=0, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv2d_out");
          auto output = (std::move(peek(stack, 6, 7))).toTensor();
          auto result_ = at::_thnn_conv2d_out(
              output,
              (std::move(peek(stack, 0, 7))).toTensor(),
  ...
  Operator(
      "aten::_thnn_conv3d(Tensor self, Tensor weight, int[3] kernel_size, Tensor? bias=None, int[3] stride=1, int[3] padding=0) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv3d");
      
          auto result_ = at::_thnn_conv3d(
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toTensor(),
              (std::move(peek(stack, 2, 6))).toIntList()->elements(),
  ...
  Operator(
      "aten::_thnn_conv_depthwise2d(Tensor self, Tensor weight, int[2] kernel_size, Tensor? bias=None, int[2] stride=1, int[2] padding=0, int[2] dilation=1, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv_depthwise2d_out");
          auto output = (std::move(peek(stack, 7, 8))).toTensor();
          auto result_ = at::_thnn_conv_depthwise2d_out(
              output,
              (std::move(peek(stack, 0, 8))).toTensor(),
              (std::move(peek(stack, 1, 8))).toTensor(),
              (std::move(peek(stack, 2, 8))).toIntList()->elements(),
  ...
  Operator(
      "aten::_thnn_conv_dilated2d(Tensor self, Tensor weight, int[2] kernel_size, Tensor? bias=None, int[2] stride=1, int[2] padding=0, int[2] dilation=1, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv_dilated2d_out");
          auto output = (std::move(peek(stack, 7, 8))).toTensor();
          auto result_ = at::_thnn_conv_dilated2d_out(
              output,
              (std::move(peek(stack, 0, 8))).toTensor(),
              (std::move(peek(stack, 1, 8))).toTensor(),
              (std::move(peek(stack, 2, 8))).toIntList()->elements(),
  ...
  Operator(
      "aten::_thnn_conv_dilated3d(Tensor self, Tensor weight, int[3] kernel_size, Tensor? bias=None, int[3] stride=1, int[3] padding=0, int[3] dilation=1) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv_dilated3d");
      
          auto result_ = at::_thnn_conv_dilated3d(
              (std::move(peek(stack, 0, 7))).toTensor(),
              (std::move(peek(stack, 1, 7))).toTensor(),
              (std::move(peek(stack, 2, 7))).toIntList()->elements(),
              (std::move(peek(stack, 3, 7))).toTensor(),
  ...
  Operator(
      "aten::_thnn_conv_transpose2d(Tensor self, Tensor weight, int[2] kernel_size, Tensor? bias=None, int[2] stride=1, int[2] padding=0, int[2] output_padding=0, int[2] dilation=1, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv_transpose2d_out");
          auto output = (std::move(peek(stack, 8, 9))).toTensor();
          auto result_ = at::_thnn_conv_transpose2d_out(
              output,
              (std::move(peek(stack, 0, 9))).toTensor(),
  ...
  Operator(
      "aten::_thnn_conv_transpose3d(Tensor self, Tensor weight, int[3] kernel_size, Tensor? bias=None, int[3] stride=1, int[3] padding=0, int[3] output_padding=0, int[3] dilation=1) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv_transpose3d");
      
          auto result_ = at::_thnn_conv_transpose3d(
              (std::move(peek(stack, 0, 8))).toTensor(),
              (std::move(peek(stack, 1, 8))).toTensor(),
              (std::move(peek(stack, 2, 8))).toIntList()->elements(),
              (std::move(peek(stack, 3, 8))).toTensor(),
  ...
  Operator(
      "aten::_thnn_fractional_max_pool2d(Tensor self, int[2] kernel_size, int[2] output_size, Tensor random_samples) -> (Tensor, Tensor)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_fractional_max_pool2d");
      
          auto result_ = at::_thnn_fractional_max_pool2d(
              (std::move(peek(stack, 0, 4))).toTensor(),
  ...
  Operator(
      "aten::_thnn_glu(Tensor self, int dim=-1) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_glu");
      
          auto result_ = at::_thnn_glu(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toInt()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_leaky_relu(Tensor self, Scalar negative_slope=0.01) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_leaky_relu");
      
          auto result_ = at::_thnn_leaky_relu(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toScalar()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_log_sigmoid(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_log_sigmoid");
      
          auto result_ = at::_thnn_log_sigmoid(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_thnn_max_pool3d_with_indices(Tensor self, int[3] kernel_size, int[3] stride=[], int[3] padding=0, int[3] dilation=1, bool ceil_mode=False) -> (Tensor, Tensor)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_max_pool3d_with_indices");
      
          auto result_ = at::_thnn_max_pool3d_with_indices(
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toIntList()->elements(),
              (std::move(peek(stack, 2, 6))).toIntList()->elements(),
              (std::move(peek(stack, 3, 6))).toIntList()->elements(),
  ...
  Operator(
      "aten::_thnn_max_unpool2d(Tensor self, Tensor indices, int[2] output_size) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_max_unpool2d");
      
          auto result_ = at::_thnn_max_unpool2d(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor(),
  ...
  Operator(
      "aten::_thnn_multilabel_margin_loss(Tensor self, Tensor target, int reduction=Mean) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_multilabel_margin_loss");
      
          auto result_ = at::_thnn_multilabel_margin_loss(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor(),
              (std::move(peek(stack, 2, 3))).toInt()
          );
  ...
  Operator(
      "aten::_thnn_nll_loss2d(Tensor self, Tensor target, Tensor? weight=None, int reduction=Mean, int ignore_index=-100, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_nll_loss2d_out");
          auto output = (std::move(peek(stack, 5, 6))).toTensor();
          auto result_ = at::_thnn_nll_loss2d_out(
              output,
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toTensor(),
              (std::move(peek(stack, 2, 6))).toTensor(),
  ...
  Operator(
      "aten::_thnn_nll_loss(Tensor self, Tensor target, Tensor? weight=None, int reduction=Mean, int ignore_index=-100, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_nll_loss_out");
          auto output = (std::move(peek(stack, 5, 6))).toTensor();
          auto result_ = at::_thnn_nll_loss_out(
              output,
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toTensor(),
              (std::move(peek(stack, 2, 6))).toTensor(),
  ...
  Operator(
      "aten::_thnn_reflection_pad1d(Tensor self, int[2] padding, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_reflection_pad1d_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_reflection_pad1d_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::_thnn_reflection_pad2d(Tensor self, int[4] padding) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_reflection_pad2d");
      
          auto result_ = at::_thnn_reflection_pad2d(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_replication_pad1d(Tensor self, int[2] padding, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_replication_pad1d_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_replication_pad1d_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::_thnn_replication_pad2d(Tensor self, int[4] padding) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_replication_pad2d");
      
          auto result_ = at::_thnn_replication_pad2d(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_rrelu_with_noise_(Tensor(a!) self, Tensor noise, Scalar lower=0.125, Scalar upper=0.333333333333, bool training=False, Generator generator=None) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::_thnn_sigmoid(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_sigmoid");
      
          auto result_ = at::_thnn_sigmoid(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_thnn_smooth_l1_loss(Tensor self, Tensor target, int reduction=Mean) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_smooth_l1_loss");
      
          auto result_ = at::_thnn_smooth_l1_loss(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor(),
              (std::move(peek(stack, 2, 3))).toInt()
          );
  ...
  Operator(
      "aten::_thnn_softshrink(Tensor self, Scalar lambd=0.5) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_softshrink");
      
          auto result_ = at::_thnn_softshrink(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toScalar()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_tanh(Tensor self) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_tanh");
      
          auto result_ = at::_thnn_tanh(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_thnn_upsample_bilinear2d(Tensor self, int[2] output_size, bool align_corners) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_upsample_bilinear2d");
      
          auto result_ = at::_thnn_upsample_bilinear2d(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements(),
              (std::move(peek(stack, 2, 3))).toBool()
          );
  ...
  Operator(
      "aten::_thnn_upsample_linear1d(Tensor self, int[1] output_size, bool align_corners) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_upsample_linear1d");
      
          auto result_ = at::_thnn_upsample_linear1d(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements(),
              (std::move(peek(stack, 2, 3))).toBool()
          );
  ...
  Operator(
      "aten::_thnn_upsample_nearest1d(Tensor self, int[1] output_size, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_upsample_nearest1d_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_upsample_nearest1d_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::_thnn_upsample_nearest2d(Tensor self, int[2] output_size) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_upsample_nearest2d");
      
          auto result_ = at::_thnn_upsample_nearest2d(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = at::cumprod_out(
              ...
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toInt(),
              (std::move(peek(stack, 2, 4))).to<at::ScalarType>()
          );
          drop(stack, 4);
          pack(stack, std::move(result_));
          return 0;
  ...
  Operator(
      "aten::empty(int[] size, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::empty_like(Tensor self, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("empty_like");
  ...
  Operator(
      "aten::empty_strided(int[] size, int[] stride, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::index_put(Tensor self, Tensor[] indices, Tensor values) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("index_put");
      
          auto result_ = at::index_put(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensorList()->elements(),
              (std::move(peek(stack, 2, 3))).toTensor()
          );
          drop(stack, 3);
          pack(stack, std::move(result_));
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          const auto options = TensorOptions()
                  ...
                  .layout((std::move(peek(stack, 3, 5))).to<at::Layout>())
                  .device((std::move(peek(stack, 4, 5))).to<at::Device>());
          auto result_ = torch::linspace((std::move(peek(stack, 0, 5))).toScalar(),
          (std::move(peek(stack, 1, 5))).toScalar(),
          options);
          drop(stack, 5);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::mean(Tensor self, int dim, bool keepdim=False, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::mean(Tensor self, int dim, *, ScalarType dtype, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("mean_out");
          auto result = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::mean_out(
  ...
  Operator(
      "aten::mean(Tensor self, int dim, bool keepdim, *, ScalarType dtype, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("mean_out");
          auto result = (std::move(peek(stack, 4, 5))).toTensor();
          auto result_ = at::mean_out(
              ...
              (std::move(peek(stack, 1, 5))).toInt(),
              (std::move(peek(stack, 2, 5))).toBool(),
              (std::move(peek(stack, 3, 5))).to<at::ScalarType>()
          );
          drop(stack, 5);
          pack(stack, std::move(result_));
          return 0;
  ...
  Operator(
      "aten::rand(int[] size, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::rand_like(Tensor self, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("rand_like");
  ...
  Operator(
      "aten::rrelu_(Tensor(a!) self, Scalar lower=0.125, Scalar upper=0.333333333333, bool training=False, Generator generator=None) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::rrelu_with_noise_(Tensor(a!) self, Tensor noise, Scalar lower=0.125, Scalar upper=0.333333333333, bool training=False, Generator generator=None) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::std(Tensor self, int dim, bool unbiased=True, bool keepdim=False) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("std");
