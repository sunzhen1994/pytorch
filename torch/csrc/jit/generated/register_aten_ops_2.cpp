...
RegisterOperators reg({
  ...
  Operator(
      "aten::_cudnn_init_dropout_state(float dropout, bool train, int dropout_seed, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_cudnn_init_dropout_state");
      
          const auto options = TensorOptions()
                  .dtype((std::move(peek(stack, 3, 6))).to<at::ScalarType>())
                  .layout((std::move(peek(stack, 4, 6))).to<at::Layout>())
                  .device((std::move(peek(stack, 5, 6))).to<at::Device>());
  ...
  Operator(
      "aten::_local_scalar(Tensor self) -> Scalar",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_local_scalar");
      
          auto result_ = at::_local_scalar(
              (std::move(peek(stack, 0, 1))).toTensor()
          );
          drop(stack, 1);
          pack(stack, std::move(result_));
  ...
  Operator(
      "aten::_sparse_coo_tensor_with_dims(int sparse_dim, int dense_dim, int[] size, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::_thnn_adaptive_avg_pool2d(Tensor self, int[2] output_size) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_adaptive_avg_pool2d");
      
          auto result_ = at::_thnn_adaptive_avg_pool2d(
              (std::move(peek(stack, 0, 2))).toTensor(),
  ...
  Operator(
      "aten::_thnn_adaptive_avg_pool2d_backward(Tensor grad_output, Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_adaptive_avg_pool2d_backward_out");
          auto grad_input = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_adaptive_avg_pool2d_backward_out(
              grad_input,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor()
          );
  ...
  Operator(
      "aten::_thnn_adaptive_avg_pool2d_forward(Tensor self, int[2] output_size) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_adaptive_avg_pool2d_forward");
      
          auto result_ = at::_thnn_adaptive_avg_pool2d_forward(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_adaptive_max_pool3d(Tensor self, int[3] output_size) -> (Tensor, Tensor)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_adaptive_max_pool3d");
      
          auto result_ = at::_thnn_adaptive_max_pool3d(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_avg_pool3d(Tensor self, int[3] kernel_size, int[3] stride=[], int[3] padding=0, bool ceil_mode=False, bool count_include_pad=True, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_avg_pool3d_out");
          auto output = (std::move(peek(stack, 6, 7))).toTensor();
          auto result_ = at::_thnn_avg_pool3d_out(
              output,
              (std::move(peek(stack, 0, 7))).toTensor(),
              (std::move(peek(stack, 1, 7))).toIntList()->elements(),
              (std::move(peek(stack, 2, 7))).toIntList()->elements(),
  ...
  Operator(
      "aten::_thnn_binary_cross_entropy(Tensor self, Tensor target, Tensor? weight=None, int reduction=Mean) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_binary_cross_entropy");
      
          auto result_ = at::_thnn_binary_cross_entropy(
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toTensor(),
              (std::move(peek(stack, 2, 4))).toTensor(),
              (std::move(peek(stack, 3, 4))).toInt()
  ...
  Operator(
      "aten::_thnn_conv3d(Tensor self, Tensor weight, int[3] kernel_size, Tensor? bias=None, int[3] stride=1, int[3] padding=0, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv3d_out");
          auto output = (std::move(peek(stack, 6, 7))).toTensor();
          auto result_ = at::_thnn_conv3d_out(
              output,
              (std::move(peek(stack, 0, 7))).toTensor(),
              (std::move(peek(stack, 1, 7))).toTensor(),
              (std::move(peek(stack, 2, 7))).toIntList()->elements(),
  ...
  Operator(
      "aten::_thnn_conv_dilated3d(Tensor self, Tensor weight, int[3] kernel_size, Tensor? bias=None, int[3] stride=1, int[3] padding=0, int[3] dilation=1, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv_dilated3d_out");
          auto output = (std::move(peek(stack, 7, 8))).toTensor();
          auto result_ = at::_thnn_conv_dilated3d_out(
              output,
              (std::move(peek(stack, 0, 8))).toTensor(),
              (std::move(peek(stack, 1, 8))).toTensor(),
  ...
  Operator(
      "aten::_thnn_conv_transpose3d(Tensor self, Tensor weight, int[3] kernel_size, Tensor? bias=None, int[3] stride=1, int[3] padding=0, int[3] output_padding=0, int[3] dilation=1, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_conv_transpose3d_out");
          auto output = (std::move(peek(stack, 8, 9))).toTensor();
          auto result_ = at::_thnn_conv_transpose3d_out(
              output,
              (std::move(peek(stack, 0, 9))).toTensor(),
              (std::move(peek(stack, 1, 9))).toTensor(),
  ...
  Operator(
      "aten::_thnn_elu(Tensor self, Scalar alpha=1, Scalar scale=1, Scalar input_scale=1) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_elu");
      
          auto result_ = at::_thnn_elu(
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toScalar(),
              (std::move(peek(stack, 2, 4))).toScalar(),
              (std::move(peek(stack, 3, 4))).toScalar()
  ...
  Operator(
      "aten::_thnn_glu(Tensor self, int dim=-1, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_glu_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_glu_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toInt()
          );
  ...
  Operator(
      "aten::_thnn_hardtanh(Tensor self, Scalar min_val=-1, Scalar max_val=1) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_hardtanh");
      
          auto result_ = at::_thnn_hardtanh(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toScalar(),
              (std::move(peek(stack, 2, 3))).toScalar()
          );
  ...
  Operator(
      "aten::_thnn_l1_loss(Tensor self, Tensor target, int reduction=Mean) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_l1_loss");
      
          auto result_ = at::_thnn_l1_loss(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor(),
  ...
  Operator(
      "aten::_thnn_leaky_relu(Tensor self, Scalar negative_slope=0.01, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_leaky_relu_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_leaky_relu_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toScalar()
          );
  ...
  Operator(
      "aten::_thnn_log_sigmoid(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_log_sigmoid_out");
          auto output = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_thnn_log_sigmoid_out(
              output,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_max_unpool2d(Tensor self, Tensor indices, int[2] output_size, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_max_unpool2d_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_thnn_max_unpool2d_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toTensor(),
              (std::move(peek(stack, 2, 4))).toIntList()->elements()
  ...
  Operator(
      "aten::_thnn_max_unpool3d(Tensor self, Tensor indices, int[3] output_size, int[3] stride, int[3] padding) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_max_unpool3d");
      
          auto result_ = at::_thnn_max_unpool3d(
              (std::move(peek(stack, 0, 5))).toTensor(),
              (std::move(peek(stack, 1, 5))).toTensor(),
              (std::move(peek(stack, 2, 5))).toIntList()->elements(),
              (std::move(peek(stack, 3, 5))).toIntList()->elements(),
  ...
  Operator(
      "aten::_thnn_mse_loss(Tensor self, Tensor target, int reduction=Mean) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_mse_loss");
      
          auto result_ = at::_thnn_mse_loss(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor(),
              (std::move(peek(stack, 2, 3))).toInt()
          );
  ...
  Operator(
      "aten::_thnn_multi_margin_loss(Tensor self, Tensor target, Scalar p=1, Scalar margin=1, Tensor? weight=None, int reduction=Mean) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_multi_margin_loss");
      
          auto result_ = at::_thnn_multi_margin_loss(
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toTensor(),
              (std::move(peek(stack, 2, 6))).toScalar(),
              (std::move(peek(stack, 3, 6))).toScalar(),
  ...
  Operator(
      "aten::_thnn_multilabel_margin_loss(Tensor self, Tensor target, int reduction=Mean, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_multilabel_margin_loss_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_thnn_multilabel_margin_loss_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toTensor(),
              (std::move(peek(stack, 2, 4))).toInt()
  ...
  Operator(
      "aten::_thnn_reflection_pad2d(Tensor self, int[4] padding, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_reflection_pad2d_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_reflection_pad2d_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::_thnn_replication_pad2d(Tensor self, int[4] padding, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_replication_pad2d_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_replication_pad2d_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::_thnn_replication_pad3d(Tensor self, int[6] padding) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_replication_pad3d");
      
          auto result_ = at::_thnn_replication_pad3d(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_rrelu_with_noise(Tensor self, Tensor noise, Scalar lower=0.125, Scalar upper=0.333333333333, bool training=False, Generator generator=None) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_rrelu_with_noise");
      
          auto result_ = at::_thnn_rrelu_with_noise(
              (std::move(peek(stack, 0, 6))).toTensor(),
              (std::move(peek(stack, 1, 6))).toTensor(),
              (std::move(peek(stack, 2, 6))).toScalar(),
              (std::move(peek(stack, 3, 6))).toScalar(),
  ...
  Operator(
      "aten::_thnn_sigmoid(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_sigmoid_out");
          auto output = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_thnn_sigmoid_out(
              output,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_smooth_l1_loss(Tensor self, Tensor target, int reduction=Mean, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_smooth_l1_loss_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_thnn_smooth_l1_loss_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toTensor(),
              (std::move(peek(stack, 2, 4))).toInt()
  ...
  Operator(
      "aten::_thnn_soft_margin_loss(Tensor self, Tensor target, int reduction=Mean) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_soft_margin_loss");
      
          auto result_ = at::_thnn_soft_margin_loss(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toTensor(),
              (std::move(peek(stack, 2, 3))).toInt()
          );
  ...
  Operator(
      "aten::_thnn_softplus(Tensor self, Scalar beta=1, Scalar threshold=20) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_softplus");
      
          auto result_ = at::_thnn_softplus(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toScalar(),
              (std::move(peek(stack, 2, 3))).toScalar()
          );
  ...
  Operator(
      "aten::_thnn_softshrink(Tensor self, Scalar lambd=0.5, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_softshrink_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_softshrink_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toScalar()
          );
  ...
  Operator(
      "aten::_thnn_tanh(Tensor self, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_tanh_out");
          auto output = (std::move(peek(stack, 1, 2))).toTensor();
          auto result_ = at::_thnn_tanh_out(
              output,
              (std::move(peek(stack, 0, 2))).toTensor()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_upsample_bilinear2d(Tensor self, int[2] output_size, bool align_corners, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_upsample_bilinear2d_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_thnn_upsample_bilinear2d_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toIntList()->elements(),
              (std::move(peek(stack, 2, 4))).toBool()
  ...
  Operator(
      "aten::_thnn_upsample_linear1d(Tensor self, int[1] output_size, bool align_corners, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_upsample_linear1d_out");
          auto output = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::_thnn_upsample_linear1d_out(
              output,
              (std::move(peek(stack, 0, 4))).toTensor(),
              (std::move(peek(stack, 1, 4))).toIntList()->elements(),
              (std::move(peek(stack, 2, 4))).toBool()
  ...
  Operator(
      "aten::_thnn_upsample_nearest2d(Tensor self, int[2] output_size, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_upsample_nearest2d_out");
          auto output = (std::move(peek(stack, 2, 3))).toTensor();
          auto result_ = at::_thnn_upsample_nearest2d_out(
              output,
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements()
          );
  ...
  Operator(
      "aten::_thnn_upsample_nearest3d(Tensor self, int[3] output_size) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_upsample_nearest3d");
      
          auto result_ = at::_thnn_upsample_nearest3d(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).toIntList()->elements()
          );
          drop(stack, 2);
  ...
  Operator(
      "aten::_thnn_upsample_trilinear3d(Tensor self, int[3] output_size, bool align_corners) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("_thnn_upsample_trilinear3d");
      
          auto result_ = at::_thnn_upsample_trilinear3d(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toIntList()->elements(),
              (std::move(peek(stack, 2, 3))).toBool()
          );
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          const auto options = TensorOptions()
                  .dtype((std::move(peek(stack, 1, 4))).to<at::ScalarType>())
                  .layout((std::move(peek(stack, 2, 4))).to<at::Layout>())
                  .device((std::move(peek(stack, 3, 4))).to<at::Device>());
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          const auto options = TensorOptions()
                  .dtype((std::move(peek(stack, 2, 5))).to<at::ScalarType>())
                  .layout((std::move(peek(stack, 3, 5))).to<at::Layout>())
                  .device((std::move(peek(stack, 4, 5))).to<at::Device>());
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          const auto options = TensorOptions()
                  .dtype((std::move(peek(stack, 4, 7))).to<at::ScalarType>())
                  .layout((std::move(peek(stack, 5, 7))).to<at::Layout>())
                  .device((std::move(peek(stack, 6, 7))).to<at::Device>());
  ...
  Operator(
      "aten::linspace(Scalar start, Scalar end, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::linspace(Scalar start, Scalar end, int steps, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("linspace_out");
          auto result = (std::move(peek(stack, 3, 4))).toTensor();
          auto result_ = at::linspace_out(
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = at::log_softmax(
              (std::move(peek(stack, 0, 3))).toTensor(),
              (std::move(peek(stack, 1, 3))).toInt(),
              (std::move(peek(stack, 2, 3))).to<at::ScalarType>()
          );
          drop(stack, 3);
          pack(stack, std::move(result_));
          return 0;
  ...
  Operator(
      "aten::ones(int[] size, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::ones_like(Tensor self, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("ones_like");
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = at::prod(
              (std::move(peek(stack, 0, 2))).toTensor(),
              (std::move(peek(stack, 1, 2))).to<at::ScalarType>()
          );
          drop(stack, 2);
          pack(stack, std::move(result_));
          return 0;
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = at::prod(
              ...
              (std::move(peek(stack, 1, 4))).toInt(),
              (std::move(peek(stack, 2, 4))).toBool(),
              (std::move(peek(stack, 3, 4))).to<at::ScalarType>()
          );
          drop(stack, 4);
          pack(stack, std::move(result_));
          return 0;
  ...
  Operator(
      "aten::randint(int high, int[] size, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::randint(int low, int high, int[] size, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("randint");
  ...
  Operator(
      "aten::randint_like(Tensor self, int high, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("randint_like");
  ...
  Operator(
      "aten::randint_like(Tensor self, int low, int high, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("randint_like");
  ...
  Operator(
      "aten::rrelu_with_noise(Tensor self, Tensor noise, Scalar lower=0.125, Scalar upper=0.333333333333, bool training=False, Generator generator=None) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::sparse_coo_tensor(int[] size, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::sparse_coo_tensor(Tensor indices, Tensor values, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("sparse_coo_tensor");
  ...
  Operator(
      "aten::sparse_coo_tensor(Tensor indices, Tensor values, int[] size, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("sparse_coo_tensor");
  ...
  Operator(
      "aten::std(Tensor self, int dim, bool unbiased=True, bool keepdim=False, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = ((std::move(peek(stack, 0, 4))).toTensor()).to(
              (std::move(peek(stack, 1, 4))).to<at::ScalarType>(),
              (std::move(peek(stack, 2, 4))).toBool(),
              (std::move(peek(stack, 3, 4))).toBool()
          );
          drop(stack, 4);
  ...
  Operator(
      ...
      [](Stack & stack) {
          ...
          auto result_ = ((std::move(peek(stack, 0, 5))).toTensor()).to(
              (std::move(peek(stack, 1, 5))).to<at::Device>(),
              (std::move(peek(stack, 2, 5))).to<at::ScalarType>(),
              (std::move(peek(stack, 3, 5))).toBool(),
              (std::move(peek(stack, 4, 5))).toBool()
          );
          drop(stack, 5);
  ...
  Operator(
      "aten::to(Tensor self, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1], bool non_blocking=False, bool copy=False) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("to");
      
          const auto options = TensorOptions()
                  .dtype((std::move(peek(stack, 1, 6))).to<at::ScalarType>())
                  .layout((std::move(peek(stack, 2, 6))).to<at::Layout>())
                  .device((std::move(peek(stack, 3, 6))).to<at::Device>());
  ...
  Operator(
      "aten::zeros(int[] size, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::zeros_like(Tensor self, *, ScalarType dtype=float, Layout layout=strided, Device device=[cpu, -1]) -> Tensor",
      [](Stack & stack) {
          autograd::profiler::RecordFunction record("zeros_like");
