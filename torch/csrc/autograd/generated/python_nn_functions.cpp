...
static PyObject * THPVariable_avg_pool2d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "avg_pool2d(Tensor input, IntList[2] kernel_size, IntList[2] stride=None, IntList[2] padding=0, bool ceil_mode=False, bool count_include_pad=True, *, Tensor out=None)",
  }, /*traceable=*/true);
...
static PyObject * THPVariable_avg_pool3d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "avg_pool3d(Tensor input, IntList[3] kernel_size, IntList[3] stride=None, IntList[3] padding=0, bool ceil_mode=False, bool count_include_pad=True, *, Tensor out=None)",
  }, /*traceable=*/true);
...
static PyObject * THPVariable_max_pool2d_with_indices(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "max_pool2d_with_indices(Tensor input, IntList[2] kernel_size, IntList[2] stride=None, IntList[2] padding=0, IntList[2] dilation=1, bool ceil_mode=False, *, TensorList[2] out=None)",
  }, /*traceable=*/true);
...
static PyObject * THPVariable_max_pool3d_with_indices(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "max_pool3d_with_indices(Tensor input, IntList[3] kernel_size, IntList[3] stride=None, IntList[3] padding=0, IntList[3] dilation=1, bool ceil_mode=False, *, TensorList[2] out=None)",
  }, /*traceable=*/true);
...
static PyObject * THPVariable_upsample_nearest1d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "upsample_nearest1d(Tensor input, IntList[1] output_size, *, Tensor out=None)",
  }, /*traceable=*/true);
...
static PyObject * THPVariable_upsample_nearest2d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "upsample_nearest2d(Tensor input, IntList[2] output_size, *, Tensor out=None)",
  }, /*traceable=*/true);
...
static PyObject * THPVariable_upsample_nearest3d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "upsample_nearest3d(Tensor input, IntList[3] output_size, *, Tensor out=None)",
  }, /*traceable=*/true);
