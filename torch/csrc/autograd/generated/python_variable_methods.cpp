...
static PyObject * THPVariable_index_put(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "index_put(TensorList indices, Tensor values)",
  }, /*traceable=*/true);
  auto& self = reinterpret_cast<THPVariable*>(self_)->cdata;
  ParsedArgs<3> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_index_put(self, r.tensorlist(0), r.tensor(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_index_put_(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_index_put_(self, r.tensorlist(0), r.tensor(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_mean(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  static PythonArgParser parser({
    ...
    "mean(int64_t dim, *, ScalarType dtype)",
    "mean(int64_t dim, bool keepdim, *, ScalarType dtype)",
  ...
  if (r.idx == 0) {
    ...
    return wrap(dispatch_mean(self, r.toInt64(0), r.scalartype(1)));
  } else if (r.idx == 3) {
    return wrap(dispatch_mean(self, r.toInt64(0), r.toBool(1), r.scalartype(2)));
  } else if (r.idx == 4) {
    return wrap(dispatch_mean(self, r.toInt64(0), r.toBool(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_std(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    ...
    return wrap(dispatch_std(self, r.toInt64(0), r.toBool(1), r.toBool(2)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
